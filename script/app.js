...
const switchItemsColor = function () {
  ...
  var itemBbColor = window
    .getComputedStyle(item, null)
    .getPropertyValue("background-color");
  var input = document.querySelector(".input");
  var inputBgColor = window
...
const switchColor = function () {
  ...
  localStorage.setItem(
    "inputColor",
    window
      .getComputedStyle(inputColor, null)
      .getPropertyValue("background-color")
  );
};
...
if (savedInputColor) {
  ...
  if (clonedItems) {
    clonedItemsColor = window
      .getComputedStyle(clonedItems, null)
      .getPropertyValue("background-color");
    input = document.querySelector(".input");
    currentInputColor = window
      .getComputedStyle(input, null)
...
activeBtn.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    itemsList.forEach((item) => {
      ...
      if (complited) item.style.display = "none";
      else {
...
localStorage.setItem(
  "inputColor",
  window.getComputedStyle(inputColor, null).getPropertyValue("background-color")
);
